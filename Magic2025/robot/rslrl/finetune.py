...
def main():
    ...
    original_log_dir = f"{project_root}/data/rslrl"
    
    env_cfg, train_cfg = pickle.load(open(f"{original_log_dir}/cfgs_rigid.pkl", "rb"))
    ...
    finetune_log_dir = f"{project_root}/data/rslrl_finetune"
