...
def CreateVehicle(init_pos):
    ...
    blade = chrono.ChBodyEasyMesh(project_root + "/data/vehicle/gator/gator_frontblade.obj", 1000, True, True, False)
...
terrain.Construct(project_root + "/data/vehicle/terrain/terrain.bmp",
...
out_dir = f"{project_root}/data/output/{pile_max_height}/soil_leveling_{push_seq}"
os.makedirs(out_dir, exist_ok=True)

# Create particle frames directory
pc_dir = f"{project_root}/data/output/{pile_max_height}/soil_leveling_{push_seq}/pc_frames"
...
blade_pv_filename = f"{project_root}/data/control_commands/{pile_max_height}_{push_seq}.txt"
    ...
    if vehicle_state == VehicleState.FORWARD_TO_POSITIVE:
        ...
        if t_back < 0:
            ...
            if time >= t_back + 1.5:
                ...
                new_control_command_file = f"{project_root}/data/control_commands/{pile_max_height}_{new_push_seq}.txt"
