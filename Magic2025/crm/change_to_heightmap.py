...
terrain_width = 3
# =========================
# TODO: Change this portion of the code to use a heightmap instead of a rectangular patch
# We will use the terrain/height_maps/bump64.bmp file as our heightmap
